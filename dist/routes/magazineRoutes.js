...
const magazineController_1 = require("../controllers/magazineController");
/**
...
const magazineRoutes = (server) => __awaiter(void 0, void 0, void 0, function* () {
    server.get('/latest', magazineController_1.handleGetLatestMagazines);
    server.get('/all', magazineController_1.handleGetAllMagazines);
});
