...
class GmailService {
    ...
    private initializeTransporter(appPassword: string) {
     ...
     */
    async sendPasswordResetEmail(to: string, code: string): Promise<EmailResult> {
        const htmlContent = `
        <!DOCTYPE html>
        <html>
        <head>
     ...
     */
    async sendAdminCredentialsEmail(to: string, name: string, password: string): Promise<EmailResult> {
        const htmlContent = `
        <!DOCTYPE html>
        <html>
        <head>
...
export const sendVerificationEmail = gmailService.sendVerificationEmail.bind(gmailService);
export const sendPasswordResetEmail = gmailService.sendPasswordResetEmail.bind(gmailService);
export const sendAdminCredentialsEmail = gmailService.sendAdminCredentialsEmail.bind(gmailService);
